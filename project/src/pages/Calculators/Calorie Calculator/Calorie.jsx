...
const CalorieCalculator = () => {
    ...
    const recalculateFromInputs = () => {
        if (age && height && weight && activityLevel && gender) {
            ...
            alert("Please fill in all fields, including gender, before recalculating.");
        }
    };
    ...
    return (
        <div className={`calorie-calculator-C ${showResults ? 'show-results-C' : ''}`}>
                ...
                {!showResults ? (
                    <>
                        ...
                        <div className="content-C">
                            ...
                            <p className='under-header-C'>Calculate Optimal Macronutrient Ratios For Your Body</p>
                            <p className='under-header-C'>Enter Your Age, Weight, And Activity Level</p>
                        </div>
                    </>
                ) : (
                    <form className="input-section-C" onSubmit={calculateCalories}>
                        ...
                        <div className="input-group-C">
                            ...
                            <input
                                type="text"
                                value={age}
                                onChange={(e) => handleNumericInput(e.target.value, setAge, age, setAgeError)}
                                placeholder="21"
                        ...
                        <div className="flex-inputs-C">
                            <div className="input-group-C">
                                ...
                                <input
                                    type="text"
                                    value={weight}
                                    onChange={(e) => handleNumericInput(e.target.value, setWeight, weight, setWeightError)}
                                    placeholder="65kg"
                                    className={`numeric-input-C ${weightError ? 'error-C' : ''}`}
                                    pattern="[0-9]*"
                                />
                                {weightError && <p className="error-message-C weight-height-error-C">{weightError}</p>}
                            </div>
                            <div className="input-group-C">
                                <label>Height</label>
                                <input
                                    type="text"
                                    value={height}
                                    onChange={(e) => handleNumericInput(e.target.value, setHeight, height, setHeightError)}
                                    placeholder="180cm"
                                    className={`numeric-input-C ${heightError ? 'error-C' : ''}`}
                                    pattern="[0-9]*"
                                />
                                {heightError && <p className="error-message-C weight-height-error-C">{heightError}</p>}
                            </div>
                        </div>
                        <div className="activity-slider-C">
                            ...
                            <div className="slider-track-C">
                                <div className="slider-dot-container-C">
                                    <button 
                                        className={`slider-dot-C ${activityLevel === 'low' ? 'active-C' : ''}`} 
                                        onClick={(e) => { e.preventDefault(); setActivityLevel('low'); }}
                                    ></button>
                                ...
                                <div className="slider-dot-container-C">
                                    <button 
                                        className={`slider-dot-C ${activityLevel === 'middle' ? 'active-C' : ''}`} 
                                        onClick={(e) => { e.preventDefault(); setActivityLevel('middle'); }}
                                    ></button>
                                ...
                                <div className="slider-dot-container-C">
                                    <button 
                                        className={`slider-dot-C ${activityLevel === 'high' ? 'active-C' : ''}`} 
                                        onClick={(e) => { e.preventDefault(); setActivityLevel('high'); }}
                                    ></button>
                                ...
                                <div className="slider-dot-container-C">
                                    <button 
                                        className={`slider-dot-C ${activityLevel === 'very-high' ? 'active-C' : ''}`} 
                                        onClick={(e) => { e.preventDefault(); setActivityLevel('very-high'); }}
                                    ></button>
                        ...
                        <div className="buttons-C">
                            ...
                            <button className="calculate-btn-C" type="submit">
                              Calculate <img src="../../../../images/Arrow right-white.svg" alt="Arrow" className="arrow-icon-C" />
                            </button>
                        </div>
                    </form>
                )}
                ...
                {!showResults ? (
                    ...
                    <div className="result-section-C">
                        ...
                        <div className="result-header-C">
                            <h2>Your Result</h2>
                            <p className="calories-C"><span className="calorie-value-C">{calories}</span> Kcal</p>
                        ...
                        <div className="macronutrients-C">
                            <div className="macro-item-C">
                                ...
                                <span className="macro-value-C">{carbs}g<span className="macro-percentage-C">/ 50%</span></span>
                            </div>
                            <div className="macro-item-C">
                                <span className="macro-label-C">Protein:</span>
                                <span className="macro-value-C">{protein}g<span className="macro-percentage-C">/ 20%</span></span>
                            </div>
                            <div className="macro-item-C">
                                <span className="macro-label-C">Fat:</span>
                                <span className="macro-value-C">{fats}g<span className="macro-percentage-C">/ 30%</span></span>
                            </div>
                        </div>
                        ...
                        {meals === 'Per Day' ? (
                            <p>Calories per day: <span className="calorie-value-C">{calories}</span> Kcal</p>
                        ) : (
                            <p>Calories per meal: <span className="calorie-value-C">{Math.round(calories / (meals === '3 Meals' ? 3 : 4))}</span> Kcal</p>
                        )}
                        <div className="result-buttons-C">
                            <button className="calculate-btn-C" onClick={recalculateFromInputs}>Calculate Again</button>
                            <button className="other-calculators-btn-C">Other Calculators</button>
                        </div>
                    </div>
                )}
            </div>
