...
const BodyFatCalc = () => {
    ...
    return (
        <div className={`calorie-calculator-F ${showResults ? 'show-results-F' : ''}`}>
                    ...
                    <>
                        ...
                        <div className="content-F">
                            ...
                            <div className='under-header-F'>
                                <p>It Estimates The Percentage Of Fat In Your Body Based On Factors Like Weight, Height, Age, Gender, Neck And Waist.</p>
                            </div>
                        </div>
                    </>
                ) : (
                    <form className="input-section-F" onSubmit={calculateBodyFat}>
                        ...
                        <div className="flex-inputs-F">
                            <div className="input-group-F">
                                ...
                                <input
                                    ...
                                    pattern="[0-9]*"
                                />
                                {weightError && <p className="error-message-F weight-height-error-F">{weightError}</p>}
                            </div>
                            <div className="input-group-F">
                                <label>Height</label>
                                <input
                                    ...
                                    pattern="[0-9]*"
                                />
                                {heightError && <p className="error-message-F weight-height-error-F">{heightError}</p>}
                            </div>
                        </div>
                        <div className="flex-inputs-F">
                            <div className="input-group-F">
                                ...
                                <input
                                    type="text"
                                    value={neck}
                                    onChange={(e) => handleNumericInput(e.target.value, setNeck, neck, setNeckError)}
                                    placeholder="40cm"
                                    className={`numeric-input-F ${neckError ? 'error-F' : ''}`}
                                    pattern="[0-9]*"
                                />
                                {neckError && <p className="error-message-F weight-height-error-F">{neckError}</p>}
                            </div>
                            <div className="input-group-F">
                                <label>Waist</label>
                                <input
                                    type="text"
                                    value={waist}
                                    onChange={(e) => handleNumericInput(e.target.value, setWaist, waist, setWaistError)}
                                    placeholder="94cm"
                                    className={`numeric-input-F ${waistError ? 'error-F' : ''}`}
                                    pattern="[0-9]*"
                                />
                                {waistError && <p className="error-message-F weight-height-error-F">{waistError}</p>}
                            </div>
                        </div>
                        <div className="bmi-buttons-F">
                            ...
                            <button className="calculate-btn-F" type="submit">
                                Calculate <img src="../../../../images/Arrow right-white.svg" alt="Arrow" className="arrow-icon-F" />
                            </button>
                        </div>
                    </form>
                )}
                ...
                {!showResults ? (
                    ...
                    <div className="result-section-F">
                        ...
                        <div className="result-header-F">
                            <h2>Your Result</h2>
                            <h3 className="bmi-value-F">Fat: {bodyFatResults?.bodyFatPercentage}%</h3>
                        </div>
                        <div className='bmi-table-div-F'>
                            <table className="bmi-table-F">
                                <tbody>
                                    ...
                                    <tr>
                                        <td className='bmi-value-F'>Ideal Body Fat For Given Age (Jackson & Pollock)</td>
                                        <td>{bodyFatResults?.idealBodyFat}%</td>
                                    </tr>
                                    <tr>
                                        <td className='bmi-value-F'>Body Fat To Lose To Reach Ideal</td>
                        ...
                        <div className='bmi-buttons-result-F'>
                            <button className="calculate-btn-F" onClick={recalculateFromInputs}>Calculate Again</button>
                            <button className="other-calculators-btn-F">Other Calculators</button>
                        </div>
                    </div>
                )}
            </div>
