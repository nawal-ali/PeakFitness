                    ...
                    <>
                        ...
                        <div className="content-B">
                            ...
                            <div className='under-header-B'>
                                <p>It Helps Categorize Your Weight As Underweight, Normal, Overweight, Or Obese, Providing A Quick Assessment Of Your Health.</p>
                            </div>
                        </div>
                    </>
                ) : (
                    <form className="input-section-B" onSubmit={calculateBmi}>
                        ...
                        <div className="flex-inputs-B">
                            <div className="input-group-B">
                                ...
                                <input
                                    ...
                                    pattern="[0-9]*"
                                />
                                {weightError && <p className="error-message-B weight-height-error-B">{weightError}</p>}
                            </div>
                            <div className="input-group-B">
                                <label>Height</label>
                                <input
                                    ...
                                    pattern="[0-9]*"
                                />
                                {heightError && <p className="error-message-B weight-height-error-B">{heightError}</p>}
                            </div>
                        </div>
                        <div className="bmi-buttons-B">
                            ...
                            <button className="calculate-btn-B" type="submit">
                                Calculate <img src="../../../../images/Arrow right-white.svg" alt="Arrow" className="arrow-icon-B" />
                            </button>
                        </div>
                    </form>
                )}
                ...
                {!showResults ? (
                    ...
                    <div className="result-section-B">
                        ...
                        <div className="result-header-B">
                            <h2>Your Result</h2>
                            <h3 className="bmi-value-B">{bmi} kg/M<sup>2</sup></h3>
                        </div>
                        <p className="subtext-B">{bmi ? `You Have A ${weightStatus} Body Weight, ${weightStatus === 'Healthy' ? 'Great Job!' : ''}` : ''}</p>
                        ...
                        <div className='bmi-buttons-result-B'>
                            <button className="calculate-btn-B" onClick={recalculateFromInputs}>Calculate Again</button>
                            <button className="other-calculators-btn-B">Other Calculators</button>
                        </div>
                    </div>
                )}
            </div>
