...
const IdealCalculator = () => {
    ...
    const calculateIdealWeight = (e) => {
        ...
        // Average in kg
        const averageIdealWeight = ((parseFloat(robinson) + parseFloat(miller) + parseFloat(devine) + parseFloat(hamwi)) / 4).toFixed(1);
        ...
        setFormulaWeights({ robinson, miller, devine, hamwi, bmiRange: bmiRangeText });
    ...
    return (
        <div className={`calorie-calculator-I ${showResults ? 'show-results-I' : ''}`}>
                ...
                {!showResults ? (
                    <>
                        ...
                        <div className="content-I">
                            ...
                            <div className='under-header-I'>
                                <p>It Helps Determine Your Ideal Body Weight Ranges Based On Popular Formulas Like Robinson, Miller, Devine, And Hamwi.</p>
                            </div>
                        </div>
                    </>
                ) : (
                    <form className="input-section-I" onSubmit={calculateIdealWeight}>
                        ...
                        <div className="gender-selection-I">
                            <button 
                                className={`gender-btn-I ${gender === 'male' ? 'active-I' : ''}`} 
                                onClick={(e) => { e.preventDefault(); setGender('male'); }}
                            >
                                Male
                            </button>
                            <button 
                                className={`gender-btn-I ${gender === 'female' ? 'active-I' : ''}`} 
                        ...
                        <div className="ideal-buttons-I">
                            ...
                            <button className="calculate-btn-I" type="submit">
                                Calculate <img src="../../../../images/Arrow right-white.svg" alt="Arrow" className="arrow-icon-I" />
                            </button>
                        </div>
                    </form>
                )}
            ...
            <div className="right-panel-I">
                {!showResults ? (
                    ...
                    <div className="result-section-I">
                        ...
                        <p className="subtext-I">The ideal weight based on popular formulas:</p>
                        ...
                        <div className='ideal-buttons-result-I'>
                            <button className="calculate-btn-I" onClick={recalculateFromInputs}>Calculate Again</button>
                            <button className="other-calculators-btn-I">Other Calculators</button>
                        </div>
                    </div>
                )}
            </div>
