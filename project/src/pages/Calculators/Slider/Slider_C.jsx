...
const Slider_C = () => {
  ...
  const items = [
    ...
    { id: 1, name: 'Calorie', img: '../../../../images/Calorie (1).png', color: '#ec7e4a' },
    { id: 2, name: 'Ideal Weight', img: '../../../../images/Ideal-Weight-Slider.png', color: '#ec7e4a' },
    { id: 3, name: 'BMI', img: '../../../../images/BMI-Slider.png', color: '#ec7e4a' },
    { id: 4, name: 'Body Fat', img: '../../../../images/Body-Fast-Slider.png', color: '#ec7e4a' }
  ];
  ...
  return (
    <div className="carousel-SC" ref={carouselRef}>
      <img src={'../../../../images/Logo-4.svg'} alt="Logo" className="logo-SC" />
      <>
              ...
              <div className="content-SC">
                <div className="title-SC">
                  {item.id === 0 ? (
                    ...
                    <>
                      {item.name} <span style={{ color: item.color }}>Calculator</span>
                    </>
                  )}
                </div>
                {item.id !== 0 && (
                ...
                <div className="content-SC">
                  <div className="title-SC">
                    {item.id === 0 ? (
                      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                        <span style={{ color: item.color }}>Choose Calculator</span>
                        <span style={{ color: '#fff', textWrap: 'nowrap' }}>to Get Started</span>
                      </div>
                    ) : (
                      <>
                        {item.name} <span style={{ color: item.color }}>Calculator</span>
